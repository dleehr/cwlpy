...
cwl_schema.WorkflowStep.add_input = add_input
cwl_schema.WorkflowStep.add_output = add_output
cwl_schema.WorkflowStep.set_run = set_run
cwl_schema.WorkflowStep.workflow_step_output_by_id = workflow_step_output_by_id
...
cwl_schema.WorkflowStepInput.set_source = set_source
